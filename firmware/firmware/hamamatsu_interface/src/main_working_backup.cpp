...
// 12-bit packing: 2400x2400x1.5 = 8.64MB (requires 16MB PSRAM)
#define SENSOR_ROWS 2400
#define SENSOR_COLUMNS 2400
#define SKIP_ROWS 0  // Full frame, no vertical crop
...
#define PIN_BIN1 25
#define PIN_PCLK 26
// Reversed data pin order: DATA_1 = former MSB pin, DATA_12 = former LSB pin (for bit-order test).
#define PIN_DATA_1 21
#define PIN_DATA_2 20
#define PIN_DATA_3 23
#define PIN_DATA_4 22
#define PIN_DATA_5 17
#define PIN_DATA_6 16
#define PIN_DATA_7 41
#define PIN_DATA_8 40
#define PIN_DATA_9 15
#define PIN_DATA_10 14
#define PIN_DATA_11 18
#define PIN_DATA_12 19
#define PIN_HSYNC 39
#define PIN_VSYNC 38
...
FASTRUN void acquire_frame() {
  ...
  // Post-process: no bit-reversal (reversed data-pin order is via defines above).
  Serial.write("Bit order: raw (reversed pins).\n");
